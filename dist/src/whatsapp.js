...
const index_1 = require("@ookamiiixd/baileys-store");
...
async function init() {
    (0, index_1.initStore)({ prisma: shared_1.prisma, logger: shared_1.logger });
...
async function createSession(options) {
    ...
    const { state, saveCreds } = await (0, index_1.useSession)(sessionId);
    ...
    const store = new index_1.Store(sessionId, socket.ev);
